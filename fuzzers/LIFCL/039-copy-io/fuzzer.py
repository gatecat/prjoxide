...
def main():
    ...
    libprjoxide.copy_db(db, "LIFCL", "SYSIO_B1_0", ["SYSIO_B1_0_C"], "C", "")
    libprjoxide.copy_db(db, "LIFCL", "SYSIO_B2_0", ["SYSIO_B2_0_C"], "C", "")
    libprjoxide.copy_db(db, "LIFCL", "SYSIO_B6_0", ["SYSIO_B6_0_C"], "C", "")
    libprjoxide.copy_db(db, "LIFCL", "SYSIO_B7_0", ["SYSIO_B7_0_C"], "C", "")
