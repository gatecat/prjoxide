...
configs = [
    ...
    ("IOL_R32A", "SIOLOGICA", FuzzConfig(job="IOL2AMODE", device="LIFCL-40", sv="../shared/empty_40.v", tiles=["CIB_R32C87:SYSIO_B2_0"])),
    ("IOL_R32B", "SIOLOGICB", FuzzConfig(job="IOL2BMODE", device="LIFCL-40", sv="../shared/empty_40.v", tiles=["CIB_R32C87:SYSIO_B2_0"])),
    ("IOL_L32A", "SIOLOGICA", FuzzConfig(job="IOL6AMODE", device="LIFCL-40", sv="../shared/empty_40.v", tiles=["CIB_R32C0:SYSIO_B6_0"])),
    ("IOL_L32B", "SIOLOGICB", FuzzConfig(job="IOL6BMODE", device="LIFCL-40", sv="../shared/empty_40.v", tiles=["CIB_R32C0:SYSIO_B6_0"])),
    ("IOL_R13A", "SIOLOGICA", FuzzConfig(job="IOL1AMODE", device="LIFCL-40", sv="../shared/empty_40.v", tiles=["CIB_R13C87:SYSIO_B1_0"])),
    ("IOL_R13B", "SIOLOGICB", FuzzConfig(job="IOL1BMODE", device="LIFCL-40", sv="../shared/empty_40.v", tiles=["CIB_R13C87:SYSIO_B1_0"])),
    ("IOL_L8A", "SIOLOGICA", FuzzConfig(job="IOL7AMODE", device="LIFCL-40", sv="../shared/empty_40.v", tiles=["CIB_R8C0:SYSIO_B7_0"])),
    ("IOL_L8B", "SIOLOGICB", FuzzConfig(job="IOL7BMODE", device="LIFCL-40", sv="../shared/empty_40.v", tiles=["CIB_R8C0:SYSIO_B7_0"])),

    ("IOL_T76A", "SIOLOGICA", FuzzConfig(job="IOL0AMODE", device="LIFCL-40", sv="../shared/empty_40.v", tiles=["CIB_R0C76:SYSIO_B0_0"])),
    ("IOL_T76B", "SIOLOGICB", FuzzConfig(job="IOL0BMODE", device="LIFCL-40", sv="../shared/empty_40.v", tiles=["CIB_R0C76:SYSIO_B0_0"])),
